            ...
            <div className="container-footer px-10 mb-[30px] text-[#888888]">
                <div className="first-footer md:flex">
                    <div className="about-footer basis-2/6 mt-5">
                        ...
                        <a className='underline underline-offset-2 hover:text-[#292929] duration-200' href='https://github.com/LoDtus/document-editing-and-management-application'>here</a>
                    </div>
